...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
      $department = new Department();
        ...
        $profileGroup=new ProfileGroup();
        $profileGroup->name="Spreader";
        $profileGroup->department_id=$department->id;
        $profileGroup->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 01";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 02";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 03";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 04";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 05";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 06";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 07";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();

        $equipment=new Equipment();
        $equipment->name="Spreader 08";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();
        
        $equipment=new Equipment();
        $equipment->name="Spreader 09";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();
        
        $equipment=new Equipment();
        $equipment->name="Spreader 10";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();
        
        $equipment=new Equipment();
        $equipment->name="Spreader 11";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();
        
        $equipment=new Equipment();
        $equipment->name="Spreader 12";
        $equipment->profile_group_id=$profileGroup->id;
        $equipment->save();
